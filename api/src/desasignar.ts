/**
 * Port mecánico de functions/src/desasignar.ts
 * Lógica de desasignación de perfiles, compartida entre el endpoint desasignarPerfil
 * y el cron de vencimientos (limpiarPerfilesVencidos).
 */
